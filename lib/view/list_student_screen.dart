...
class _ListStudentScreenState extends State<ListStudentScreen> {
  ...
  void initState() {
    ...
    super.initState();
    studentListController.getStudentListByCat(widget.selectedCategoryId!); //
  }
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: CupertinoSpinBox(
                              onChanged: (value) {
                                studentInfoController.updatePresenceMember(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  schoolController.text = studentListController
                                      .studentList[index].school!;
                                  nationalCodeController.text =
                                      studentListController
                                          .studentList[index].nationalCode!;
                                  phoneNumberController.text =
                                      studentListController
                                          .studentList[index].mobilePhone!;
                                  gradeIdController = studentListController
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  log(index.toString());
                                  studentInfoController.deleteMemberFromClass(
                                      studentListController
                                          .studentList[index].id!); //////
                                  studentListController.getStudentListByCat(
  ...
  _showBottomSheetAddMember(bool isEditMode, {int? id}) {
    int selectedGradeId = isEditMode?gradeIdController: 0;
    String selectedGradeName =studentListController.classGradeList[selectedGradeId].gradeName! ;
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) {
                selectedGradeId = studentListController.classGradeList
                    .indexWhere((category) => category.gradeName == value);
              },
            ),
            const SizedBox(height: 8.0),
            TextFormField(
            ...
            ElevatedButton(
              onPressed: () {
                studentInfoController.singleStudentInfo.update((val) {
                  ...
                  val.score = 0;
                  val.presence = 0;
                  val.id = studentListController.studentList.last.id!+1;
                });
                if (!isEditMode) {
                  studentInfoController.addNewMemberToClass();
                } else {
                  studentInfoController.updateMemberOfClass(id!);
                }
                studentListController
